                ...
                >
                    <div className="p-4 p-md-5">
                        <div className="d-flex align-items-center mb-4">
                            ...
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill={brandColor} viewBox="0 0 16 16">
                                    <path d="M14 14V4.5L9.5 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2zM9.5 3A1.5 1.5 0 0 0 11 4.5h2V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h5.5v2z" />
                                    <path d="M4.5 9a.5.5 0 0 0 0 1h7a.5.5 0 0 0 0-1h-7zM4.5 12a.5.5 0 0 0 0 1h7a.5.5 0 0 0 0-1h-7z" />
                                </svg>
                            </div>
                            <h2 className="fw-bold mb-0" style={{ color: brandColor }}>Terms of Service</h2>
                        </div>
                            ...
                            {[
                                {
                                    ...
                                    content: "Welcome to AURUM, tailored for jewellery merchants. By accessing or using our platform, you agree to be bound by these Terms of Service."
                                },
                                {
                                ...
                                },
                                {
                                    ...
                                    content: "While we employ high-standard security measures, merchants are responsible for maintaining the confidentiality of their account credentials and customer data input."
                                },
                                {
                                    title: "5. Termination",
                                    content: "We reserve the right to terminate accounts that violate these terms or engage in fraudulent activity."
                                }
                            ].map((section, index) => (
                                <div
                                    key={index}
